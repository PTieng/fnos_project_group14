      ...
      <div>
        <section className="vi_tri_trang">
          <div className="container">
            <p>
              <a href="index.html"> FNOS </a>/<a href="#"> Quần</a> /
              <a href="nike.html">Short - Jogger</a>/
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-12 col-lg-6">
                ...
                <br />
                <p>
                  Giày {product.name} hiện đã có sẵn tại FNOS với mức giá hấp
                  dẫn, đừng bỏ lỡ cơ hội của mình nhé! Cập nhật nhanh nhất lịch
                  ra mắt của các mẫu giày mới nhất và tin tức thời trang trong
                  nước và trên thế giới bằng cách theo dõi FNOS trên Facebook
                  hoặc Instagram.
                </p>
                <br />
